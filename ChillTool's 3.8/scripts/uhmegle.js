(function() {
    ...
    function showToSModal() {
        ...
        <div id="tosModal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.85); backdrop-filter: blur(5px); z-index: 10000; display: flex; justify-content: center; align-items: center;">
            <div style="background: #23223a; border-radius: 10px; width: 90%; max-width: 600px; padding: 24px; box-shadow: 0 5px 25px rgba(0,0,0,0.8); border: 1px solid #444; position: relative;">
                ...
                <button id="closeTosBtn" style="background: #007bff; color: white; border: none; padding: 10px 15px; border-radius: 5px; cursor: pointer; width: 100%; transition: background 0.2s;" onmouseover="this.style.background='#0069d9'" onmouseout="this.style.background='#007bff'">
